...
void gui::launcher_entry::draw_impl() {
...

  {
    ...
    ImGui::PlotHistogram("", getter, nullptr, info.total - info.loaded.size(), 0, nullptr,
                         0, 1, ImVec2(200, 60));
...

  {
    ...
    ImGui::PlotHistogram("", getter, nullptr, info.loaded.size(), 0, nullptr,
                         0, 1, ImVec2(70, 60));

    ImGui::PopStyleColor(1);
  }

  if (ImGui::Button("Load", {200, 0})) {
    callbacks_.on_load(0);
  }
