...
gui::histo_plot_entry::histo_plot_entry(
    std::shared_ptr<class logger_factory> factory, std::string name)
...
//void gui::histo_plot_entry::log(std::string key, std::vector<double> data) {
//
//}
...
gui::polar_entry::polar_entry(std::shared_ptr<class logger_factory> factory,
